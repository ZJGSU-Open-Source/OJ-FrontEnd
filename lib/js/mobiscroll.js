...
(function(a, b, c, d) {
	...
	g.Scroller = function(b, A, C) {
		...
		function y(b) {
			...
			a.each(e, function(b, e) {
				...
				d += '<div role="option" aria-selected="false" class="dw-li dw-v" data-val="' + f[b] + '"' + (z[b] ? ' aria-label="' + z[b] + '"' :
					"") + ' style="height:' + w + "px;line-height:" + w + 'px;"><div class="dw-i"' + (1 < ca ? ' style="line-height:' + Math.round(w / ca) + "px;font-size:" + Math.round(0.8 * (w / ca)) + 'px;"' : "") + ">" + e + i._processItem(a, 0.2) + "</div></div>";
				c++
			});
			return d += "</div>"
		}
		...
		i._processItem = new Function("$, p", function() {
			...
			d = "";
			var c;
			for (c = 0; 1062 > c; ++c) d += "0123456789abcdef" [((a *
				"0123456789abcdef".indexOf("" [c]) -
				a * b) % 16 + 16) % 16];
			b = d;
			d = b.length;
			a = [];
